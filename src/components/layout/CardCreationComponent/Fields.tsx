      ...
      <CardContainer alwaysOn={true}>
        <div className="flex flex-col gap-2 px-3 py-2 rounded-md relative w-full bg-white dark:bg-neutral-950 cursor-auto">
          ...
          <input
            ...
            className="dark:bg-neutral-800 dark:border-black dark:focus:border-neutral-600 focus:border-neutral-500 outline-none border-2 p-1 px-4 rounded-lg font-Poppins w-full"
          />
        </div>
      </CardContainer>
    </div>
