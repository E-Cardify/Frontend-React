    ...
    return (
        <>
            <div className="min-h-[70vh] max-h-[70vh] overflow-auto">
                <div>
                    <h1 className="text-xl font-Poppins font-bold p-2 px-3 border-b-2 border-neutral-200">{t("Personal")}</h1>
                ...
                <div>
                    <h1 className="text-xl font-Poppins font-bold p-2 px-3 border-b-2 border-neutral-200">{t("Affiliation")}</h1>
                    <div className="px-3 flex flex-col gap-5 py-3">
